...
import software.dan.credit.app.system.dto.CreditView
import software.dan.credit.app.system.dto.CreditViewList
...
class CreditResource(
    ...
    @GetMapping
    fun findAllByCustomerById (@RequestParam( value = "customerId" ) customerId: Long): ResponseEntity <List<CreditViewList>> {
